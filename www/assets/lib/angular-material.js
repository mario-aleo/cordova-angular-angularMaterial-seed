    ...
    return {
      template:
          ...
          '<div class="md-datepicker-input-container" ' +
            ...
            '<div ng-click="ctrl.openCalendarPane($event)"> <input ng-disabled="true" class="md-datepicker-input" aria-haspopup="true" ' +
                'ng-focus="ctrl.setFocused(true)" ng-blur="ctrl.setFocused(false)"> </div>' +
